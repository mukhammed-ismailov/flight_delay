...
**Подготовка данных для обучения модели и обучение модели** (Скажем сразу, что не стоить ожидать 
хороших резльтата от модели. Так как в данные явно сгенерированы или собраны с грубыми ошибками)
